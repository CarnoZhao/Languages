...
alias python='/mnt/d/Applications/Anaconda_Linux/bin/python3'
...
#__conda_setup="$(CONDA_REPORT_ERRORS=false '/mnt/d/Applications/Anaconda_Linux/bin/conda' shell.bash hook 2> /dev/null)"
#if [ $? -eq 0 ]; then
#    \eval "$__conda_setup"
#else
