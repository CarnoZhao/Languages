...
# Path to your oh-my-zsh installation.
  export ZSH="/home/carno/.oh-my-zsh"
...
[[ -s /home/carno/.autojump/etc/profile.d/autojump.sh ]] && source /home/carno/.autojump/etc/profile.d/autojump.sh
alias python='python3'
alias Download='cd /mnt/d/Download'
alias Codes='cd /mnt/d/Codes'
alias gitpush='git add -A; git commit -m $@; git push'
alias fy='python /mnt/d/Codes/OtherFiles/fy.py $@'
alias sm='/mnt/d/Applications/SumatraPDF/SumatraPDF.exe $@'
alias pyc='cmd.exe /c python $@'
alias c='cmd.exe /c $@'
alias t='tree -h'
...
__conda_setup="$(CONDA_REPORT_ERRORS=false '/mnt/d/Applications/Anaconda/bin/conda' shell.bash hook 2> /dev/null)"
if [ $? -eq 0 ]; then
    \eval "$__conda_setup"
else
    if [ -f "/mnt/d/Applications/Anaconda/etc/profile.d/conda.sh" ]; then
        . "/mnt/d/Applications/Anaconda/etc/profile.d/conda.sh"
        CONDA_CHANGEPS1=false conda activate base
    else
        \export PATH="/mnt/d/Applications/Anaconda/bin:$PATH"
    fi
fi
unset __conda_setup
unsetopt BG_NICE
